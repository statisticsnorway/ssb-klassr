...
#'   group labels, or `NULL` to skip applying labels. The names of the list
...
#' The names of the label columns are equal to `names(labellers)`. If
#' `labellers` is `NULL`, no label columns are provided.
#' @export
